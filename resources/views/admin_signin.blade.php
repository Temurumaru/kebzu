...
<head>
  ...
  <title>Sign In Kebzu Admin</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Войдите в Аккаунт</h5>
                    <p class="text-center small">Пожалуйста введите ваш логин и пароль</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" action="{{route('signInAdminC')}}" method="post" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Пожалуйста введуите пароль</div>
                    </div>
